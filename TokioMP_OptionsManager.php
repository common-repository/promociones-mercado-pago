...
class TokioMP_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'promociones-mercado-pago'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'promociones-mercado-pago'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'promociones-mercado-pago'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'promociones-mercado-pago'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'promociones-mercado-pago');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'promociones-mercado-pago'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'promociones-mercado-pago');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'promociones-mercado-pago'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'promociones-mercado-pago') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'promociones-mercado-pago');
            case 'false':
                return __('false', 'promociones-mercado-pago');

            case 'Administrator':
                return __('Administrator', 'promociones-mercado-pago');
            case 'Editor':
                return __('Editor', 'promociones-mercado-pago');
            case 'Author':
                return __('Author', 'promociones-mercado-pago');
            case 'Contributor':
                return __('Contributor', 'promociones-mercado-pago');
            case 'Subscriber':
                return __('Subscriber', 'promociones-mercado-pago');
            case 'Anyone':
                return __('Anyone', 'promociones-mercado-pago');
        }
        return $optionValue;
    }
